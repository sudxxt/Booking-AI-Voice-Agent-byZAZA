...
class OpenAISTTAdapter(STTComponent):
    ...
    def _compose_options(self, runtime_options: Optional[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        return {
            ...
            "model": model,
            "language": runtime_options.get("language", self._pipeline_defaults.get("language", getattr(self._provider_defaults, "language", None))),
            "prompt": runtime_options.get("prompt", self._pipeline_defaults.get("prompt", getattr(self._provider_defaults, "stt_prompt", None))),
