        ...
        try:
            ...
            try:
                logger.info(
                    ...
                    playback_type=playback_type,
                    gap_ms=gap_ms,
                    adaptive_min_ms=(intelligent_buffer_ms if playback_type != "greeting" else base_config_ms),
                    adaptive_warmup_ms=(intelligent_buffer_ms if playback_type != "greeting" else base_config_ms),
